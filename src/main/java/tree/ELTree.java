...
public class ELTree implements Cloneable {
	...
	public AbstractReasoner rs;
	public OWLOntology ontology;

	public void checkTree() {
	}

	public ELTree(AbstractReasoner rs, OWLOntology ontology) {
		this.rs = rs;
	...
	public ELTree(AbstractReasoner rs) {
		this.rs = rs;
		subsumptionHierarchy = rs.getClassHierarchy();
		roleHierarchy = rs.getObjectPropertyHierarchy();
	}

	public ELTree(AbstractReasoner rs, OWLClassExpression description) throws Exception {
	...
	public void constructTree(OWLClassExpression description, ELNode node) throws Exception {
		if (description.isOWLThing()) {
			...
			ELNode newNode = new ELNode(node, op, ((OWLDataSomeValuesFrom) description).getFiller());
